...
/* harmony export */ });
/* harmony import */ var remotion_no_react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(60808);
...
const parseColor = (value) => {
    const colored = remotion_no_react__WEBPACK_IMPORTED_MODULE_0__.NoReactInternals.processColor(value)
        .toString(16)
        .padStart(8, '0');
...
const zColor = () => zod__WEBPACK_IMPORTED_MODULE_1__.z.string()
    .refine((value) => {
    try {
        parseColor(value);
        return true;
...
const zTextarea = () => zod__WEBPACK_IMPORTED_MODULE_1__.z.string().describe(REMOTION_TEXTAREA_BRAND);
...
var esm = __webpack_require__(35242);
